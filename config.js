...
export const adminAddress = testVersion ? "tb1p9w5uzcx8nnysa763syhsmmdqkvxavdnywrstcgah35lsdeq5305qwwmfnn" : "";
...
//export const BLOCK_CYPHER_TOKEN = "773276f678a14967beb9ba24391f7000";
export const BLOCK_CYPHER_TOKEN = "c038f4a1029642c0821560417e92e376";
...
export const OPENAPI_UNISAT_URL = testVersion ? 'https://open-api-testnet.unisat.io' : 'https://open-api.unisat.io';
export const BLOCK_CYPHER_URL = testVersion ? 'https://api.blockcypher.com/v1/btc/test3' : 'https://api.blockcypher.com/v1/btc/main';
//export const BLOCK_CYPHER_URL = testVersion ? 'https://api.blockcypher.com/v1/bcy/test' : 'https://api.blockcypher.com/v1/btc/main';

export const MEMPOOL_API = testVersion ? "https://mempool.space/testnet/api" : "https://mempool.space/api";
export const SERVER_URL = testVersion ? "http://localhost:3000" : "https://perfect-brc20-demo.netlify.app";